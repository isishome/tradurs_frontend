...
import d2r400 from '@/assets/d2r_400.webp'
import d2r800 from '@/assets/d2r_800.webp'
import cain400 from '@/assets/cain_400.webp'
import cain800 from '@/assets/cain_800.webp'

const route = useRoute()
const { t } = useI18n({ useScope: 'global' })

const d2r = import.meta.env.VITE_APP_D2R_ORIGIN
      ...
      <div class="col-6">
        <div class="q-ma-lg">
          ...
          >
            <q-img
              :src="d4800"
              :srcset="`${d4400} 400w, ${d4800} 800w`"
              sizes="(max-width: 400px) 400w, (min-width: 400px) and (max-width: 800px) 800w"
              :ratio="1"
            />
            <div>
      ...
      <div class="col-6">
        <div class="q-ma-lg">
          ...
          >
            <q-img
              :src="d4800"
              :srcset="`${d2r400} 400w, ${d2r800} 800w`"
              sizes="(max-width: 400px) 400w, (min-width: 400px) and (max-width: 800px) 800w"
              :ratio="1"
            />
            <div>
      ...
      <div class="col-6">
        <div class="q-ma-lg">
          ...
          >
            <q-img
              :src="cain800"
              :srcset="`${cain400} 400w, ${cain800} 800w`"
              sizes="(max-width: 400px) 400w, (min-width: 400px) and (max-width: 800px) 800w"
              :ratio="1"
            />
            <div>
